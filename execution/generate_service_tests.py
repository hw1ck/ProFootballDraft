...
TEST_PATH = "backend/src/test/java/com/profootballdraft/backend/services/PlayerServiceTest.java"

with open(POM_PATH, "r") as f:
    pom = f.read()

if "<artifactId>h2</artifactId>" not in pom:
    pom = pom.replace(
        "<dependencies>",
...
TEST_CONTENT = """package com.profootballdraft.backend.services;
...
print("Added H2 dependency and wrote PlayerServiceTest.java")
